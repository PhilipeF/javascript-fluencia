...
*/
setTimeout(() => {
  console.log('Um segundo e meio se passaram desde que a página foi caregada')
}, 1500)
...
const buttonInitCount = document.querySelector('.button-init-counter')
const buttonStopCount = document.querySelector('.button-stop-counter')
...
buttonInitCount.onclick = () => {
    count++
}

buttonStopCount.onclick = () => {
  clearInterval(timer)
